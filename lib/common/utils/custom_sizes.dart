...
class Sizes {
  const Sizes._internal();

  static const Sizes instance = Sizes._internal();
  factory Sizes() => instance;
...
//
  ...
  spaceBetweenTitles({double? height}) {
    return SizedBox(height: height ?? dimen_20);
  }

  spaceBetweenSubtitles({double? height}) {
    return SizedBox(height: height ?? dimen_10);
  }
}
